...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Anh có vài lời muốn nói với bu:';
document.querySelector('.Description .modal-body').innerHTML = 'anh yêu em. <i';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/vhung.24/'>Việt Hưng<a>";
